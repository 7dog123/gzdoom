...
// [GEC] change friction
CUSTOM_CVAR (Float, scalefriction, 1.f, 0)
{
	if (self < 0)
		self = 1.f;

	FRICTION_BASE[0] = clamp(FixedMul(0xE800, FLOAT2FIXED(self)), 0, FRACUNIT);//ORIG_FRICTION
	FRICTION_BASE[1] = clamp(FixedMul(0xF900, FLOAT2FIXED(self)), 0, FRACUNIT);//FRICTION_LOW
	FRICTION_BASE[2] = clamp(FixedMul(0xEB00, FLOAT2FIXED(self)), 0, FRACUNIT);//FRICTION_FLY
}
...
#define	BT_R1	   8 //straferight

#define	BT_TIR	   16 //fire
#define	BT_CIR	   32 //use 
#define	BT_X	   64 //strafe
#define	BT_SQR	   128 //speed

#define	BT_SLT	   256 //map
#define	BT_0	   512 //??
#define	BT_1	   1024 //??
#define	BT_SRT	   2048 //start

#define	BT_UP	   4096 //forwardmove
#define	BT_RIGHT   8192 //trunright
#define	BT_DOWN	   16384 //backwardmove
#define	BT_LEFT	   32768 //trunleft

int DEMOCOUNT = 0;
int rundem=0;
unsigned char DEMO[2812*2] = {
	,
	...
	0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x10, 0x80, 0x00, 0x00,
	0x10, 0x80, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00,
	0x80, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x10, 0x20, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00,
	0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x80, 0x10, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x10, 0x20, 0x00, 0x00,
	0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	...
	,
	...
	0x00, 0x90, 0x00, 0x00, 0x00, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,
	0x10, 0x80, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00,
	0x00, 0x60, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00,
	...
	,
	...
	,
	...
	0x00, 0x90, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	...
	,
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x80, 0x20, 0x00, 0x00,
	...
	0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,
	0x10, 0x80, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
//PSXDOOM.EXE offset 0x5539A0
/*
//forwardmove[2]
00000400 -> 0x40000 -> 262144 -> 4.0
00000600 -> 0x60000 -> 393216 -> 6.0
//sidemove[2]
00800300 -> 0x38000 -> 229376 -> 3.5
00800500 -> 0x58000 -> 360448 -> 5.5
//angleturn[20]
2C010000 -> 300
2C010000 -> 300
F4010000 -> 500
...
//Doom 64 (U) [!].z64 offset 0x5BC5F
/*
//forwardmove[2]
00E00000 -> E000  -> 57344 -> 0.875
00600100 -> 16000 -> 90112 -> 1.375
//sidemove[2]
00E00000 -> E000  -> 57344 -> 0.875
00600100 -> 16000 -> 90112 -> 1.375
...
CVAR (Bool, angleturndouble, false, CVAR_DEMOSAVE|CVAR_ARCHIVE)

#define A_SLOWTURNTICS 10
#define ANGLE_D64 20
fixed_t	A_Angleturn[] =
{
	//PSX
	300,300,500, 500, 600, 700, 800, 900, 900,1000,	//Angleturn
	800,800,900,1000,1000,1200,1200,1300,1300,1400,	//FastAngleturn
	//D64
...
void G_BuildTiccmd (ticcmd_t *cmd)
{
	...
	//if((gametic & 1)== 0 && (rundem == 1)&& gamestate == GS_LEVEL && (paused !=1) && (menuactive == MENU_Off) && (ConsoleState == c_up))
	if(level.time & 1 && (rundem == 1))
	{
	//int old;
	b0 = DEMO[DEMOCOUNT];DEMOCOUNT++;
	b1 = DEMO[DEMOCOUNT];DEMOCOUNT++;
	b2 = DEMO[DEMOCOUNT];DEMOCOUNT++;
	b3 = DEMO[DEMOCOUNT];DEMOCOUNT++;//}
	cmd2 = (b3 << 24) | (b2 << 16) | (b1 << 8) | b0;

	//cmd2 =	DEMO_f[DEMOCOUNT];
	/*b0 = DEMO[DEMOCOUNT-4];
	b1 = DEMO[DEMOCOUNT-3];
	b2 = DEMO[DEMOCOUNT-2];
	b3 = DEMO[DEMOCOUNT-1];
	old = (b3 << 24) | (b2 << 16) | (b1 << 8) | b0;*/
		//cmd2 =	DEMO_f[DEMOCOUNT];
		//old =	DEMO_f[DEMOCOUNT-1];DEMOCOUNT++;
	Printf("cmd -> %d\n",cmd2);

	/*if ((cmd2 & BT_LEFT) && (old & BT_LEFT) )
	{turnheld_c ++;}
	else if ((cmd2 & BT_RIGHT) && (old & BT_RIGHT) )
	{turnheld_c ++;}
	else
	{turnheld_c = 0;}

	if (turnheld_c >= SLOWTURNTICS_C)
	{turnheld_c = SLOWTURNTICS_C-1;}*/
	...
	//Printf("rngseed -> %d\n",rngseed);
		...
		if(rundem == 1)
		{
		Button_Attack.bDown = false;
		Button_Use.bDown = false;
		Button_Strafe.bDown = false;
		Button_Speed.bDown = false;
		Button_Forward.bDown = false;
		Button_Back.bDown = false;
		Button_Right.bDown = false;
		Button_Left.bDown = false;
		Button_MoveLeft.bDown = false;
		Button_MoveRight.bDown = false;
		}
	}

	if(cmd2 & BT_RIGHT)	{Button_Right.bDown = true;}
	if(cmd2 & BT_LEFT)	{Button_Left.bDown = true;}

	if(cmd2 & BT_UP)	{Button_Forward.bDown = true;}
	if(cmd2 & BT_DOWN)	{Button_Back.bDown = true;}
	if(cmd2 & BT_L1)	{Button_MoveLeft.bDown = true;}
	if(cmd2 & BT_R1)	{Button_MoveRight.bDown = true;}

	if(cmd2 & BT_SLT)	{}//printf("map\n");}
	if(cmd2 & BT_SRT)	{rundem=0;}//printf("start\n");}

	
	if(cmd2 & BT_TIR)	{Button_Attack.bDown = true;/*cmd->ucmd.buttons |= BT_ATTACK;*/}

	if(cmd2 & BT_CIR)	{Button_Use.bDown= true;}//printf("use \n");}
	if(cmd2 & BT_X)		{Button_Strafe.bDown= true;}//printf("strafe\n");}
	if(cmd2 & BT_SQR)	{Button_Speed.bDown= true;}//printf("speed\n");}
	//-------------------------
	...
	*cmd = *base;
	...
	if(gameinfo.playeranglemode == 0)//DoomPc
	{
	...
	else if(gameinfo.playeranglemode == 1 || gameinfo.playeranglemode == 2)//DoomPsx Doom64
	{
		if(Button_Left.bDown)
		  turnheld++; 
		else if(Button_Right.bDown)
		  turnheld++; 
		else 
		  turnheld = 0; 

		if(turnheld >= A_SLOWTURNTICS)
		  turnheld = A_SLOWTURNTICS-1;
	}
	...
	else
	{
		...
		{
			bool AngD64 = (gameinfo.playeranglemode == 2 ? true : false);

			if(speed && !((Button_Forward.bDown|Button_Back.bDown)))
			{
				if(Button_Right.bDown) 
				{
					if(angleturndouble)
						G_AddViewAngle((A_Angleturn[turnheld + (AngD64 ? 20 : 0) + A_SLOWTURNTICS] * 4) / 3); 
					else
						G_AddViewAngle(A_Angleturn[turnheld + (AngD64 ? 20 : 0) + A_SLOWTURNTICS]); 
			...
			else
			{
				...
				{
					if(angleturndouble)
						G_AddViewAngle((A_Angleturn[turnheld + (AngD64 ? 20 : 0)] * 4) / 3); 
					else
						G_AddViewAngle( A_Angleturn[turnheld + (AngD64 ? 20 : 0)]); 
					LocalKeyboardTurner = true;
				}
				if(Button_Left.bDown) 
				{
